...
| `:app` | Interface Jetpack Compose | 🚧 en cours — **schéma Canvas, navigation 2 onglets, onglet Perçage complet, éditeur de machine** ; restent i18n fr/en, unités, persistance et machines multiples |
